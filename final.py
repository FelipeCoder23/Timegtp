...
def main():
    ...
    if prices:
        ...
        # Guardar los datos en un archivo CSV en la misma carpeta donde se ejecuta el script
        current_directory = os.path.dirname(os.path.abspath(__file__))
        csv_filename = os.path.join(current_directory, f'{crypto_id}_historical_data.csv')
